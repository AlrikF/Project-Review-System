...
<h4>Student Email:</h4>
<input type="text" name="Student_email"><br><br>

<button class="button button1" name="button" value="Update Student">Update Student details</button>
</div></div>
...
<button class="button button1" name="button" value="Update Group">Update Group details</button>
</div></div>
</form>
